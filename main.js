...
class UI {
  ...
  openRulesModal() {
    this.showModal();
    const rules_image = circle.className.includes("active")
  ...
  bordeStyle(chooseOption, choice) {
    ...
    if (choice === "paper") {
      paper.style.border =
        option === "scissors"
          ? "12px solid hsl(39, 89%, 49%)"
          : option === "rock"
          ? "12px solid hsl(349,71%, 52%)"
          : "12px solid hsl(230,89%, 62%)";
  ...
  updateResult(choice) {
    ...
    if (selected === computerSelected) {
      ...
      (selected === "paper" && computerSelected === "rock") ||
    ...
    if (choice === "spock") {
      spockHard.style.border =
        option === "scissors"
          ...
          ? "12px solid hsl(349,71%, 52%)"
          : option === "spock"
          ? "12px solid  hsl(189, 59%, 53%)"
          : option === "lizard"
          ? "12px solid   hsl(261, 73%, 60%)"
          : "12px solid hsl(230,89%, 62%)";
